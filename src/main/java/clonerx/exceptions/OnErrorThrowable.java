...
import clonerx.plugins.RxJavaErrorHandler;
import clonerx.plugins.RxJavaPlugins;
...
public final class OnErrorThrowable extends RuntimeException {
    ...
    public static OnErrorThrowable from(Throwable t) {
        ...
        Throwable cause = rx.exceptions.Exceptions.getFinalCause(t);
    ...
    public static Throwable addValueAsLastCause(Throwable e, Object value) {
        ...
        Throwable lastCause = rx.exceptions.Exceptions.getFinalCause(e);
        ...
        rx.exceptions.Exceptions.addCause(e, new OnNextValue(value));
        return e;
    }
